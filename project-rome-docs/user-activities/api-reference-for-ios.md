# <a name="ios-user-activities-api-reference"></a><span data-ttu-id="d1c6e-101">iOS ユーザー アクティビティの API リファレンス</span><span class="sxs-lookup"><span data-stu-id="d1c6e-101">iOS User Activities API reference</span></span>
